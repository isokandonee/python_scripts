# -*- coding: utf-8 -*-
"""
Created on Sat Dec 11 00:08:49 2021
...
fruits = ["abandon", "ability", "able", "about", "above", "absent", "absorb", "abstract",
    ...
    "tool", "tooth", "top", "topic", "topple", "torch", "tornado", "tortoise", "toss", 
    ...
    "truck", "true", "truly", "trumpet", "trust", "truth", "try", "tube", "tuition", 
...
amt = int(input("How many words should be printed "))

def printer():
    i = 0
    #amt = int(input("How many words should be printed "))
    #num = int(input("Which word should be printed "))
    while i < amt:
        num_list = random.randint(0, 2048)
        print(fruits[num_list])
        i += 1
printer()

#"""amt = int(input("How many words should be printed "))
#num_list = random.sample(range(0,2048), amt)
#print(fruits[num_list])"""#
print(" --- ")

i = 0
while i < amt:
    num_list2 = random.choice(fruits)
    print(num_list2)
    i += 1
